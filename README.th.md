...
- **หลักฐานสำคัญกว่าคำสัญญา** — ชุดเทสต์ตรึงพฤติกรรมของด่านป้องกันไว้ และ CI พิสูจน์ซ้ำทุกครั้งในทุก pull request: รันชุดย่อยที่พกพาได้ (portable subset) บน Ubuntu, รันเกือบทั้งหมดบน macOS แบบ hosted, และรันแบบครบตามสัญญาทั้งหมดบน self-hosted macOS runner ซึ่งจะล้มเหลวทันทีถ้ามีชุดเทสต์แม้แต่ชุดเดียวถูกข้าม
...
| [DESIGN.md](DESIGN.md) | ผู้ที่อยากรู้อยากเห็น | เอกสารการออกแบบต้นฉบับ (บันทึกการรีวิวแบบ seat-review ถูกนำออกจาก tree ที่เผยแพร่แล้ว และเหลืออยู่แค่ในประวัติ repository) |
